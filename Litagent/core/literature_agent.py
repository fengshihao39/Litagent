...
from Litagent.services.analysis.paper_analyzer import (
    analyze_paper,
    format_analysis,
    generate_citations,
)
from Litagent.services.analysis.paper_understanding import deep_analyze_papers
...
from Litagent.services.search.multi_search import (
...
class LiteratureAgent:
    def __init__(self):
        ...
        self.output_dir = str(Path(__file__).resolve().parents[2] / "output")
